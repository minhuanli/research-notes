...
This project contains my research notes based on a Tufte them Jekyll. I forked and modified the theme from stanford [cs228 note site](https://ermongroup.github.io/cs228-notes/). 
