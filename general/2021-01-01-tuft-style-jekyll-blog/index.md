...
<span class="newthought">The Tufte Jekyll theme</span> is an attempt to create a website design with the look and feel of Edward Tufte's books and handouts. Tufte’s style is known for its extensive use of sidenotes, tight integration of graphics with text, and well-set typography.<!--more--> The idea for this project is essentially cribbed wholesale from Tufte and R Markdown's Tufte Handout format{% include sidenote.html id="note-1" note="See [tufte-latex.github.io/tufte-latex/](https://tufte-latex.github.io/tufte-latex/) and [rmarkdown.rstudio.com/tufte_handout_format](http://rmarkdown.rstudio.com/tufte_handout_format.html)" %}. This page is an adaptation of the [Tufte Handout PDF](http://rmarkdown.rstudio.com/examples/tufte-handout.pdf).
...
{% include marginfigure.html id='mf-id-1' url='assets/img/rhino.png' description='F.J. Cole, “The History of Albrecht Dürer’s Rhinoceros in Zoological Literature,” *Science, Medicine, and History: Essays on the Evolution of Scientific Thought and Medical Practice* (London, 1953), ed. E. Ashworth Underwood, 337-356. From page 71 of Edward Tufte’s *Visual Explanations*.'  %}
...
```{{ "{% include marginfigure.html id='mf-id-whatever' url='assets/img/rhino.png' description='F.J. Cole, “The History of Albrecht Dürer’s Rhinoceros in Zoological Literature,” *Science, Medicine, and History: Essays on the Evolution of Scientific Thought and Medical Practice* (London, 1953), ed. E. Ashworth Underwood, 337-356. From page 71 of Edward Tufte’s *Visual Explanations*.' "}} %}```.
...
If you need a main column image or figure, another custom liquid tag is available to use. Oddly enough, it is named 'fullwidth', and this markup:

```{{ "{% include maincolumn_img.html src='assets/img/napoleons-march.png' caption='Napoleon's March *(Edward Tufte’s English translation)*' "}} %}```

Yields this:

{% include maincolumn_img.html src='assets/img/rhino.png' caption='F.J. Cole, “The History of Albrecht Dürer’s Rhinoceros in Zoological Literature,” *Science, Medicine, and History: Essays on the Evolution of Scientific Thought and Medical Practice* (London, 1953), ed. E. Ashworth Underwood, 337-356. From page 71 of Edward Tufte’s *Visual Explanations*.'  %}
...
{% include marginnote.html id='table-1-id' note='*Table 1*: A table with default style formatting' %}
...
{% include marginnote.html id='table-2-id' note='*Table 2*: A table with booktabs style formatting' %}
<div class="table-wrapper">
...
{% include marginnote.html id='tableID-3' note='Table 3: a table created with *Markdown Extra* markup using only the default table styling' %}
...
{% include marginnote.html id='Table-ID4' note='Table 4: a simple table showing left, center, and right alignment of table headings and data' %}
